...
/**
 * Brace mark tile matching the app/tray icon (`dsh-plugin-desktop/build/tray-icon.svg`):
 ...
 * `plugins/dsh-enterprise/src/client/Brand.tsx` (same artwork, same tokens):
 ...
 *
 * Artwork matches `dsh-plugin-desktop/build/tray-icon.svg` exactly: the
