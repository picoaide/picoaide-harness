...
const PANEL_NAME = 'skill-center'

/**
 * Sidebar foot action opening the skill center modal, stacked above the
 * Settings trigger (registered into `sidebar.footer.action`). Opening this
 * panel evicts sibling panels (connectors, browser, cron, task) via the
  ...
  return (
    <>
      ...
      >
        ...
        {props.wide && <span style={LABEL}>{t('skill.title')}</span>}
      </button>
