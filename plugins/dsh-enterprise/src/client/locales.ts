...
export const zh = {
  ...
  'skill.fetch': '下载',
  'skill.fetching': '下载中…',
  'skill.downloaded': '已开始下载 {name}',
  'skill.failed': '下载失败，请重试',
  'skill.loading': '加载中…',
  'skill.empty': '暂无可用技能',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'skill.close': 'Close',
  'skill.fetch': 'Download',
  'skill.fetching': 'Downloading…',
  'skill.downloaded': 'Downloading {name}',
  'skill.failed': 'Download failed, please retry',
