...
| **Example MCP** | Recruitment and HR all-in-one AI colleague: talent recommendations, recruitment updates, attendance & performance, approval todos; smart talent sourcing, interview analysis, and interviewer evaluation; OAuth + streamable-http |
