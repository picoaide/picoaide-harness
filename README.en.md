...
- **Connector hub**: built-in SalesEasy (NeoCRM), Example MCP and other MCP connectors with OAuth + PKCE, locally encrypted credential storage, and dynamic MCP registration;
