...
- This project pins both the published DSH `0.1.2-rc.1` family and the corresponding official `deepseek-harness/` release source (`dsh-v0.1.2-rc.1`). Product builds still resolve published package interfaces rather than linking the source checkout.
