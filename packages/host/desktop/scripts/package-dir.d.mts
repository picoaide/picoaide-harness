...
/** `packageDir()` 的注入缝（测试用；生产一律用缺省值）。 */
export interface PackageDirOptions {
...
/**
 * 打一条 unpacked 产物（应用根走暂存白名单副本）。
 * @param options - 注入缝；缺省 = 生产路径。
 */
export declare function packageDir(options?: PackageDirOptions): void
