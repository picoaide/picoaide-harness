...
export declare const zh: {
    ...
    readonly 'job.agent': "执行智能体";
    readonly 'job.agentDefault': "默认智能体（部署默认）";
    readonly 'job.permission': "权限";
    readonly 'job.permissionNone': "不使用（默认）";
    readonly 'job.permissionRead': "只读";
    readonly 'job.permissionWrite': "工作区可写";
    readonly 'job.permissionFull': "完全访问";
    readonly 'job.nameRequired': "请填写任务名称";
    readonly 'job.promptTextRequired': "请填写执行内容（发送给智能体的提示词）";
    readonly 'job.promptText': "执行内容（提示词）";
    readonly 'job.save': "保存";
    readonly 'job.cancel': "取消";
    readonly 'job.history': "执行详情";
    readonly 'job.deleteConfirm': "确定删除该定时任务吗？";
    readonly 'job.showHistory': "展开执行详情";
    readonly 'job.hideHistory': "收起执行详情";
