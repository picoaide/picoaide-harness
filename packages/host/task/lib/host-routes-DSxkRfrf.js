import { TASK_API_PREFIX, parseActionEnvelope } from "./protocol.js";
...
function makeTaskRoutes(service) {
	const guard = (req, res) => {
...
//#endregion
export { makeTaskRoutes as t };

//# sourceMappingURL=host-routes-DSxkRfrf.js.map