...
export const zh = {
  ...
  'account.password.success': '密码已修改,请使用新密码重新登录',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'account.password.success': 'Password changed. Please sign in with your new password.',
  ...
  'session.title': 'Enterprise Login',
