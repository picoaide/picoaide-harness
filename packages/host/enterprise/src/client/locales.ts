...
export const zh = {
  ...
  'capability.builtinTitle': '平台内置技能',
  'capability.builtinHint': '随服务端下发，按需安装到本机（不自动安装）',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'capability.builtinTitle': 'Built-in skills',
  'capability.builtinHint': 'Shipped with the server; install locally on demand (never automatic)',
