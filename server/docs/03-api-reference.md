...
| GET/PUT | `/api/server/admin/connectors`、`/connectors/:id` | 连接器目录 CRUD(0042;Example-A/sales-easy 等定义服务端下发) |
...
```json
{
  ...
  "connectors": [{ "id": "example-a", "name": "示例 MCP 智能体", "auth_mode": "oauth", "definition": { ... } }]
}
```
