...
const TEMPLATES: { label: string; name: string; description: string; authMode: AuthMode; json: string }[] = [
  {
    label: 'Example-A(远程 MCP + OAuth 发现)',
    name: '示例 MCP 智能体',
    description: '招聘和人事一体的 AI 同事,把查询与执行收进一个对话。',
    authMode: 'oauth',
    json: '{"auth":{"discoveryUrl":"https://mcp-a.example.com/mcp","clientId":"","authorizeUrl":"","tokenUrl":"","redirectUri":"http://127.0.0.1/callback","pkce":true,"publicClient":true,"scopes":"offline_access"},"mcp":[{"serverName":"example-a","transport":"streamable-http","url":"https://mcp-a.example.com/mcp"}]}',
  },
  {
