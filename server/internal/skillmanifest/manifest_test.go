...
func TestCompareVersions(t *testing.T) {
	cases := []struct {
		...
		{"1.2.0-rc.1", "1.2.0-rc.1.1", -1}, // 前缀全等时,更长标识符列表更大
		{"1.2.0-rc.10", "1.2.0-rc.10", 0},
		{"1.2.0-rc.1", "1.2.0-beta.1", 1},                                 // 字母段按字典序:b < r
		{"1.2.0-rc.1", "1.2.0-alpha", 1},                                  // 数字段 < 字母段? rc.1 vs alpha:rc > alpha 字典序
		{"1.2.0-99999999999999999999", "1.2.0-123456789012345678901", -1}, // 20 位 < 21 位(按长度,不溢出)
